ATTRIBUTE_PROMPTS = {
    ...
    "main_image_url": "The URL of the main product image.",
    "features": "A list of key features or specifications of the product.",
    "tech_specs": "Technical specifications of the product (e.g., dimensions, weight, material)."
}
